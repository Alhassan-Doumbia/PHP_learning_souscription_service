...
<body>
    ...
    <main>
        <?php
            ...
            switch($package){
                case 1 : $userData1['InternetConnection']+=3; $userData1['moneyAmount']-=1000; 
                break;

                case 2 :  $userData1['InternetConnection']+=4.5; $userData1['moneyAmount']-=2000;
                break;

                case 3 : $userData1['InternetConnection']+=10;$userData1['moneyAmount']-=5000;
                break;
